  ...
  try {
    ...
    const article = await prisma.article.update({
      ...
      data: {
        ...
        ...(seoKeywords !== undefined && { seoKeywords: seoKeywords == null ? null : String(seoKeywords) }),
        ...(metaDescription !== undefined && { metaDescription: metaDescription == null ? null : String(metaDescription) }),
