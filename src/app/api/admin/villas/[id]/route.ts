  ...
  try {
    ...
    const villa = await prisma.villa.update({
      ...
      data: {
        ...
        ...(status !== undefined && { status: status == null ? null : String(status) }),
        ...(rentPeriod !== undefined && { rentPeriod: rentPeriod == null ? null : String(rentPeriod) }),
        ...(propertyType !== undefined && { propertyType: propertyType == null ? null : String(propertyType) }),
